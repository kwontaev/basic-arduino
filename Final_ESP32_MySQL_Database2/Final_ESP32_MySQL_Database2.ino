...
const char* ssid = "airple.net";
const char* password = "07078678825";
//======================================== 
...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    http.begin("http://192.168.1.20/testcode/ESP32_ESP32_MySQL_Database/Final/getdata.php");  //--> Specify request destination
    ...
    http.begin("http://192.168.1.20/testcode/ESP32_ESP32_MySQL_Database/Final/updateDHT11data_and_recordtable.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
